...
def replace_llama_forward_with_reuse_forward():
    transformers.models.llama.modeling_llama.LlamaAttention.forward = reuse_forward
    transformers.models.llama.modeling_llama.LlamaSdpaAttention.forward = reuse_forward